...
class ComposerStaticInit92af1b9922f64f50ffadafaa6b3e9f0e
{
    ...
    public static $classMap = array (
        ...
        'Umodi\\Attribute\\Incomplete' => __DIR__ . '/../..' . '/src/Attribute/Incomplete.php',
        'Umodi\\Attribute\\Skipped' => __DIR__ . '/../..' . '/src/Attribute/Skipped.php',
        'Umodi\\Di\\Invoker\\FakeInvoker' => __DIR__ . '/../..' . '/src/Di/Invoker/FakeInvoker.php',
        'Umodi\\Di\\Invoker\\Invoker' => __DIR__ . '/../..' . '/src/Di/Invoker/Invoker.php',
        'Umodi\\Di\\Invoker\\InvokerInterface' => __DIR__ . '/../..' . '/src/Di/Invoker/InvokerInterface.php',
        'Umodi\\Di\\Resolution' => __DIR__ . '/../..' . '/src/Di/Resolution.php',
        'Umodi\\Di\\Resolver\\CompositeResolver' => __DIR__ . '/../..' . '/src/Di/Resolver/CompositeResolver.php',
        'Umodi\\Di\\Resolver\\ParameterResolverInterface' => __DIR__ . '/../..' . '/src/Di/Resolver/ParameterResolverInterface.php',
        'Umodi\\Di\\Resolver\\ProvidedMapResolver' => __DIR__ . '/../..' . '/src/Di/Resolver/ProvidedMapResolver.php',
        'Umodi\\Di\\Resolver\\PsrContainerResolver' => __DIR__ . '/../..' . '/src/Di/Resolver/PsrContainerResolver.php',
        'Umodi\\Exception\\InjectionException' => __DIR__ . '/../..' . '/src/Exception/InjectionException.php',
        'Umodi\\Exception\\TestPreconditionFailedException' => __DIR__ . '/../..' . '/src/Exception/TestPreconditionFailedException.php',
        'Umodi\\ProgressWatcher\\CliProgressWatcher' => __DIR__ . '/../..' . '/src/ProgressWatcher/CliProgressWatcher.php',
        'Umodi\\ProgressWatcher\\JunitXmlProgressWatcher' => __DIR__ . '/../..' . '/src/ProgressWatcher/JunitXmlProgressWatcher.php',
        'Umodi\\ProgressWatcher\\ProgressWatcherInterface' => __DIR__ . '/../..' . '/src/ProgressWatcher/ProgressWatcherInterface.php',
        'Umodi\\ProgressWatcher\\ProgressWatcherSpy' => __DIR__ . '/../..' . '/src/ProgressWatcher/ProgressWatcherSpy.php',
        'Umodi\\Result\\AssertCollector' => __DIR__ . '/../..' . '/src/Result/AssertCollector.php',
        'Umodi\\Result\\AssertResult' => __DIR__ . '/../..' . '/src/Result/AssertResult.php',
        'Umodi\\Result\\Assertion' => __DIR__ . '/../..' . '/src/Result/Assertion.php',
        'Umodi\\Result\\TestOutcome' => __DIR__ . '/../..' . '/src/Result/TestOutcome.php',
        'Umodi\\RunnableUnitInterface' => __DIR__ . '/../..' . '/src/RunnableUnitInterface.php',
        'Umodi\\Severity\\AssertResolution' => __DIR__ . '/../..' . '/src/Severity/AssertResolution.php',
        'Umodi\\Severity\\DefaultExceptionClassifier' => __DIR__ . '/../..' . '/src/Severity/DefaultExceptionClassifier.php',
        'Umodi\\Severity\\DefaultSeverityPolicy' => __DIR__ . '/../..' . '/src/Severity/DefaultSeverityPolicy.php',
        'Umodi\\Severity\\ExceptionClassifierInterface' => __DIR__ . '/../..' . '/src/Severity/ExceptionClassifierInterface.php',
        'Umodi\\Severity\\SeverityPolicyInterface' => __DIR__ . '/../..' . '/src/Severity/SeverityPolicyInterface.php',
        'Umodi\\Severity\\TestResolutionAggregator' => __DIR__ . '/../..' . '/src/Severity/TestResolutionAggregator.php',
        'Umodi\\Unit' => __DIR__ . '/../..' . '/src/Unit.php',
        'Umodi\\UnitInterface' => __DIR__ . '/../..' . '/src/UnitInterface.php',
        'Umodi\\UnitLoader\\FileSystemUnitLoader' => __DIR__ . '/../..' . '/src/UnitLoader/FileSystemUnitLoader.php',
        'Umodi\\UnitLoader\\InMemoryUnitLoader' => __DIR__ . '/../..' . '/src/UnitLoader/InMemoryUnitLoader.php',
        'Umodi\\UnitLoader\\UnitLoaderInterface' => __DIR__ . '/../..' . '/src/UnitLoader/UnitLoaderInterface.php',
        'Umodi\\UnitRunner' => __DIR__ . '/../..' . '/src/UnitRunner.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit92af1b9922f64f50ffadafaa6b3e9f0e::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit92af1b9922f64f50ffadafaa6b3e9f0e::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit92af1b9922f64f50ffadafaa6b3e9f0e::$classMap;
